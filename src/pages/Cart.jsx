...
function Cart(){
    ...
    return(
        <div>
           {
             cart.length?(<div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
                    ...
                    <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
                        <div>
                            ...
                            <p className="font-[600] text-xl text-slate-700">
                                Total Items:- <span className="font-semibold text-2xl">{cart.length}</span></p>
                            </div>
             ...
             </div>): (<div className="w-screen h-[calc(100vh-80px)] flex flex-col gap-6 justify-center items-center">
